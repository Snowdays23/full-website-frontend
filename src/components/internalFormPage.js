...
import { FormPageSport } from './internal-formpage/formPageSport';
import { FormPageCatering } from './internal-formpage/formPageCatering';
import Button from '@mui/material/Button';
import Send from '@mui/icons-material/Send';
import { FormPageGeneral } from './internal-formpage/formPageGeneral';
import PrivacyPolicy from '../assets/docs/PrivacyPolicy.pdf';
import PaymentPolicy from '../assets/docs/InternalPaymentPolicy.pdf';
import TermsAndConditions from '../assets/docs/InternalTermsAndCondition.pdf';
import { Checkbox } from '@mui/material';
import Alert from '@mui/material/Alert';
import AlertTitle from '@mui/material/AlertTitle';

export const InternalFormPage = () => {
