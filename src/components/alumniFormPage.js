...
import { FormPageSport } from './alumni-formpage/formPageSport';
import { FormPageCatering } from './alumni-formpage/formPageCatering';
import Button from '@mui/material/Button';
import Send from '@mui/icons-material/Send';
import { FormPageGeneral } from './alumni-formpage/formPageGeneral';
import PrivacyPolicy from '../assets/docs/PrivacyPolicy.pdf';
import PaymentPolicy from '../assets/docs/AlumniPaymentPolicy.pdf';
import TermsAndConditions from '../assets/docs/AlumniTermsAndCondition.pdf';
import { Checkbox } from '@mui/material';
import Alert from '@mui/material/Alert';
import AlertTitle from '@mui/material/AlertTitle';

export const AlumniFormPage = () => {
