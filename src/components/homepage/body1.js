            ...
            <div className = "wrapper-outside-body relative offset-up-10 relative ">
                ...
                <div className='row justify-content-center mt-5' >
                    ...
                    <div className='col-lg-6 col-10'>
                        ...
                        <p className='font-josefin normal-text'>We are more than thrilled to announce the comeback of Europe’s biggest winter sports event, organized by students, for students</p>
